...
public class CustomerASMDeserializerFactory extends ASMDeserializerFactory {
    public final ASMClassLoader classLoader;
    protected final AtomicLong seed              = new AtomicLong();

    final static String         DefaultJSONParser = type(com.alibaba.fastjson.parser.DefaultJSONParser.class);
    final static String         JSONLexerBase     = type(com.alibaba.fastjson.parser.JSONLexerBase.class);
    public CustomerASMDeserializerFactory(ClassLoader parentClassLoader) {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo) throws Exception {
        ...
        String className = "CustomerFastjsonASMDeserializer_" + seed.incrementAndGet() + "_" + clazz.getSimpleName();
        String packageName = CustomerASMDeserializerFactory.class.getPackage().getName();
        String classNameType = packageName.replace('.', '/') + "/" + className;
        String classNameFull = packageName + "." + className;

        ClassWriter cw = new ClassWriter();
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, classNameType, type(CustomerJavaBeanDeserializer.class), null);



        _init(cw, new CustomerASMDeserializerFactory.Context(classNameType, config, beanInfo, 3));
        _createInstance(cw, new CustomerASMDeserializerFactory.Context(classNameType, config, beanInfo, 3));
        _deserialze(cw, new CustomerASMDeserializerFactory.Context(classNameType, config, beanInfo, 5));

        _deserialzeArrayMapping(cw, new CustomerASMDeserializerFactory.Context(classNameType, config, beanInfo, 4));
    ...
    private void _setFlag(MethodVisitor mw, CustomerASMDeserializerFactory.Context context, int i) {
    ...
    private void _isFlag(MethodVisitor mw, CustomerASMDeserializerFactory.Context context, int i, Label label) {
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, CustomerASMDeserializerFactory.Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(CustomerJavaBeanDeserializer.class), "scanEnum",
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitMethodInsn(INVOKESTATIC, type(CustomerJavaBeanDeserializer.class),
                            "parseArray",
                ...
                mw.visitVarInsn(ALOAD, CustomerASMDeserializerFactory.Context.parser);
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(CustomerJavaBeanDeserializer.class), "getFieldType",
                ...
                if (fieldClass == Date.class) {
                    ...
                    mw.visitTypeInsn(NEW, type(Date.class));
                    mw.visitInsn(DUP);
                    ...
                    mw.visitMethodInsn(INVOKESPECIAL, type(Date.class), "<init>", "(J)V");
                    mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
...
//                mw.visitInsn(POP);
                ...
                mw.visitMethodInsn(INVOKESPECIAL, //
                        type(CustomerJavaBeanDeserializer.class), //
    ...
    private void _deserialze(ClassWriter cw, CustomerASMDeserializerFactory.Context context) {
...
//                mw.visitLabel(enumNull_);
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, type(CustomerJavaBeanDeserializer.class),
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ILOAD, 4);
        mw.visitMethodInsn(INVOKESPECIAL, type(CustomerJavaBeanDeserializer.class), //
                "deserialze", //
                "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void defineVarLexer(CustomerASMDeserializerFactory.Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1);
    ...
    private void _createInstance(CustomerASMDeserializerFactory.Context context, MethodVisitor mw) {
        JavaBeanInfo beanInfo = context.beanInfo;
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, type(CustomerJavaBeanDeserializer.class), "clazz", "Ljava/lang/Class;");
            mw.visitMethodInsn(INVOKESPECIAL, type(CustomerJavaBeanDeserializer.class), "createInstance",
    ...
    private void _batchSet(CustomerASMDeserializerFactory.Context context, MethodVisitor mw) {
        _batchSet(context, mw, true);
    }

    private void _batchSet(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, boolean flag) {
    ...
    private void _loadAndSet(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        Class<?> fieldClass = fieldInfo.fieldClass;
        Type fieldType = fieldInfo.fieldType;
    ...
    private void _set(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, FieldInfo fieldInfo) {
    ...
    private void _setContext(CustomerASMDeserializerFactory.Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1); // parser
        mw.visitVarInsn(ALOAD, context.var("context"));
    ...
    private void _deserialize_endCheck(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, Label reset_) {
    ...
    private void _deserialze_list_obj(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
    ...
    private void _quickNextToken(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, int token) {
        Label quickElse_ = new Label(), quickEnd_ = new Label();
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "getCurrent", "()C");
    ...
    private void _quickNextTokenComma(CustomerASMDeserializerFactory.Context context, MethodVisitor mw) {
    ...
    private void _getCollectionFieldItemDeser(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, FieldInfo fieldInfo,
                                              Class<?> itemType) {
    ...
    private void _deserialze_obj(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getLastResolveTask", "()" + desc(com.alibaba.fastjson.parser.DefaultJSONParser.ResolveTask.class));
        mw.visitVarInsn(ASTORE, context.var("resolveTask"));

        mw.visitVarInsn(ALOAD, context.var("resolveTask"));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getContext", "()" + desc(ParseContext.class));
        mw.visitFieldInsn(PUTFIELD, type(com.alibaba.fastjson.parser.DefaultJSONParser.ResolveTask.class), "ownerContext", desc(ParseContext.class));

        mw.visitVarInsn(ALOAD, context.var("resolveTask"));
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.name);
        mw.visitMethodInsn(INVOKEVIRTUAL, type(CustomerJavaBeanDeserializer.class), "getFieldDeserializer",
                "(Ljava/lang/String;)" + desc(FieldDeserializer.class));
        mw.visitFieldInsn(PUTFIELD, type(com.alibaba.fastjson.parser.DefaultJSONParser.ResolveTask.class), "fieldDeserializer", desc(FieldDeserializer.class));
    ...
    private void _deserObject(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        _getFieldDeser(context, mw, fieldInfo);

        Label instanceOfElse_ = new Label(), instanceOfEnd_ = new Label();
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            mw.visitInsn(DUP);
            mw.visitTypeInsn(INSTANCEOF, type(CustomerJavaBeanDeserializer.class));
            mw.visitJumpInsn(IFEQ, instanceOfElse_);

            mw.visitTypeInsn(CHECKCAST, type(CustomerJavaBeanDeserializer.class)); // cast
            mw.visitVarInsn(ALOAD, 1);
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, type(CustomerJavaBeanDeserializer.class), "deserialze",
                    "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, type(fieldClass)); // cast
            mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
    ...
    private void _getFieldDeser(CustomerASMDeserializerFactory.Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        Label notNull_ = new Label();
        mw.visitVarInsn(ALOAD, 0);
    ...
    private void _init(ClassWriter cw, CustomerASMDeserializerFactory.Context context) {
        for (int i = 0, size = context.fieldInfoList.length; i < size; ++i) {
            FieldInfo fieldInfo = context.fieldInfoList[i];
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, 2);
        mw.visitMethodInsn(INVOKESPECIAL, type(CustomerJavaBeanDeserializer.class), "<init>",
    ...
    private void _createInstance(ClassWriter cw, CustomerASMDeserializerFactory.Context context) {
