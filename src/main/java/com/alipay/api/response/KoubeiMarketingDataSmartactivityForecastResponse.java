 ...
 */
@ApiModel(description = " ALIPAY API: koubei.marketing.data.smartactivity.forecast response.")
public class KoubeiMarketingDataSmartactivityForecastResponse extends AlipayResponse {
     ...
     * 领取数量 上限值
     */
    @ApiModelProperty(notes = " 领取数量 上限值")
     ...
     * 领取数量 下限值
     */
    @ApiModelProperty(notes = " 领取数量 下限值")
     ...
     * 新增曝光数量 上限值
     */
    @ApiModelProperty(notes = " 新增曝光数量 上限值")
     ...
     * 新增曝光数量 下限值
     */
    @ApiModelProperty(notes = " 新增曝光数量 下限值")
     ...
     * 提升复购率区间上限
     */
    @ApiModelProperty(notes = " 提升复购率区间上限")
     ...
     * 提升复购率区间下限
     */
    @ApiModelProperty(notes = " 提升复购率区间下限")
     ...
     * 活动收益金额(分)区间上限值
     */
    @ApiModelProperty(notes = " 活动收益金额(分)区间上限值")
     ...
     * 活动收益金额(分)区间下限值
     */
    @ApiModelProperty(notes = " 活动收益金额(分)区间下限值")
     ...
     * 核销数量区间上限
     */
    @ApiModelProperty(notes = " 核销数量区间上限")
     ...
     * 核销数量区间下限
     */
    @ApiModelProperty(notes = " 核销数量区间下限")
