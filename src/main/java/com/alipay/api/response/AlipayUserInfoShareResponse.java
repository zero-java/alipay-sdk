 ...
 */
@ApiModel(description = " ALIPAY API: alipay.user.info.share response.")
public class AlipayUserInfoShareResponse extends AlipayResponse {
     ...
     */
    @ApiModelProperty(notes = " 经营/业务范围（用户类型是公司类型时才有此字段）。")
     ...
     * 证件号码，结合证件类型使用.
     */
    @ApiModelProperty(notes = " 证件号码，结合证件类型使用.")
    @ApiField("cert_no")
     ...
     * 12:台湾居民来往大陆通行证
     */
    @ApiModelProperty(notes = " 0:身份证1:护照2:军官证3:士兵证4:回乡证5:临时身份证6:户口簿7:警官证8:台胞证9:营业执照10:其它证件11:港澳居民来往内地通行证12:台湾居民来往大陆通行证")
    @ApiField("cert_type")
     ...
     * 用户支付宝邮箱登录名
     */
    @ApiModelProperty(notes = " 用户支付宝邮箱登录名")
    @ApiField("email")
     ...
     */
    @ApiModelProperty(notes = " 企业代理人证件有效期（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业代理人证件号码（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业代理人证件类型, 返回值参考cert_type字段（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业代理人姓名（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业法人证件有效期（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 法人证件号码（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业法人证件类型, 返回值参考cert_type字段（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业法人名称（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业法人证件图片（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业相关证件图片，包含图片地址（目前需要调用alipay.user.certify.image.fetch转换一下）及类型（用户类型是公司类型时才有此字段）。")
     ...
     * STATEORGAN(党政国家机关)
     */
    @ApiModelProperty(notes = " 公司类型，包括（用户类型是公司类型时才有此字段）：CO(公司)INST(事业单位),COMM(社会团体),NGO(民办非企业组织),STATEORGAN(党政国家机关)")
    @ApiField("firm_type")
     ...
     * 性别（F：女性；M：男性）。
     */
    @ApiModelProperty(notes = " 性别（F：女性；M：男性）。")
    @ApiField("gender")
     ...
     * T--被冻结；F--未冻结
     */
    @ApiModelProperty(notes = " 余额账户是否被冻结。T--被冻结；F--未冻结")
     ...
     */
    @ApiModelProperty(notes = " 是否通过实名认证。T是通过 F是没有实名认证。")
     ...
     */
    @ApiModelProperty(notes = " 营业执照有效期，yyyyMMdd或长期，（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 企业执照号码（用户类型是公司类型时才有此字段）。")
    @ApiField("license_no")
     ...
     * 支付宝会员等级
     */
    @ApiModelProperty(notes = " 支付宝会员等级")
     ...
     */
    @ApiModelProperty(notes = " 组织机构代码（用户类型是公司类型时才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 证件有效期（用户类型是个人的时候才有此字段）。")
     ...
     */
    @ApiModelProperty(notes = " 个人证件图片（用户类型是个人的时候才有此字段）。")
     ...
     * 支付宝用户的userId
     */
    @ApiModelProperty(notes = " 支付宝用户的userId")
    @ApiField("user_id")
     ...
     */
    @ApiModelProperty(notes = " 若用户是个人用户，则是用户的真实姓名；若是企业用户，则是企业名称。")
    @ApiField("user_name")
     ...
     * W代表已注册，未激活的账户
     */
    @ApiModelProperty(notes = " 用户状态（Q/T/B/W）。Q代表快速注册用户T代表已认证用户B代表被冻结账户W代表已注册，未激活的账户")
     ...
     * 1代表公司账户2代表个人账户
     */
    @ApiModelProperty(notes = " 用户类型（1/2）1代表公司账户2代表个人账户")
    @ApiField("user_type")
