 ...
 */
@ApiModel(description = " ALIPAY API: alipay.trade.query response.")
public class AlipayTradeQueryResponse extends AlipayResponse {
     ...
     * 支付宝店铺编号
     */
    @ApiModelProperty(notes = " 支付宝店铺编号")
     ...
     */
    @ApiModelProperty(notes = " 买家实付金额，单位为元，两位小数。该金额代表该笔交易买家实际支付的金额，不包含商户折扣等金额")
     ...
     * 买家在支付宝的用户id
     */
    @ApiModelProperty(notes = " 买家在支付宝的用户id")
     ...
     */
    @ApiModelProperty(notes = " 本次交易支付所使用的单品券优惠的商品优惠信息")
     ...
     * 交易支付使用的资金渠道
     */
    @ApiModelProperty(notes = " 交易支付使用的资金渠道")
     ...
     */
    @ApiModelProperty(notes = " 行业特殊信息（例如在医保卡支付业务中，向用户返回医疗信息）。")
     ...
     */
    @ApiModelProperty(notes = " 交易中用户支付的可开具发票的金额，单位为元，两位小数。该金额代表该笔交易中可以给用户开具发票的金额")
     ...
     */
    @ApiModelProperty(notes = " 买家支付宝用户号，该字段将废弃，不要使用")
    @ApiField("open_id")
     ...
     */
    @ApiModelProperty(notes = " 积分支付的金额，单位为元，两位小数。该金额代表该笔交易中用户使用积分支付的金额，比如集分宝或者支付宝实时优惠等")
     ...
     */
    @ApiModelProperty(notes = " 实收金额，单位为元，两位小数。该金额为本笔交易，商户账户能够实际收到的金额")
     ...
     * 本次交易打款给卖家的时间
     */
    @ApiModelProperty(notes = " 本次交易打款给卖家的时间")
     ...
     * 请求交易支付中的商户店铺的名称
     */
    @ApiModelProperty(notes = " 请求交易支付中的商户店铺的名称")
    @ApiField("store_name")
     ...
     * 商户机具终端编号
     */
    @ApiModelProperty(notes = " 商户机具终端编号")
     ...
     */
    @ApiModelProperty(notes = " 交易的订单金额，单位为元，两位小数。该参数的值为支付时传入的total_amount")
     ...
     */
    @ApiModelProperty(notes = " 交易状态：WAIT_BUYER_PAY（交易创建，等待买家付款）、TRADE_CLOSED（未付款交易超时关闭，或支付完成后全额退款）、TRADE_SUCCESS（交易支付成功）、TRADE_FINISHED（交易结束，不可退款）")
     ...
     * 本交易支付时使用的所有优惠券信息
     */
    @ApiModelProperty(notes = " 本交易支付时使用的所有优惠券信息")
