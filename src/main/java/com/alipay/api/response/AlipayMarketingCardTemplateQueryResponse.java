 ...
 */
@ApiModel(description = " ALIPAY API: alipay.marketing.card.template.query response.")
public class AlipayMarketingCardTemplateQueryResponse extends AlipayResponse {
     ...
     */
    @ApiModelProperty(notes = " 会员卡类型：OUT_MEMBER_CARD：外部权益卡")
    @ApiField("card_type")
     ...
     * 模板样式信息(钱包展现效果)
     */
    @ApiModelProperty(notes = " 模板样式信息(钱包展现效果)")
