 ...
 */
@ApiModel(description = " ALIPAY API: koubei.marketing.data.indicator.query response.")
public class KoubeiMarketingDataIndicatorQueryResponse extends AlipayResponse {
     ...
     */
    @ApiModelProperty(notes = " JSON格式数组，每个对象表示一个门店某个具体日期的指标信息，KEY为指标代码，VALUE为该指标对应的值,各biz_type入参以及返回值的详细信息参见")
     ...
     * 总条目数,供计算分页信息使用
     */
    @ApiModelProperty(notes = " 总条目数,供计算分页信息使用")
    @ApiField("total_size")
     ...
     */
    @ApiModel(description = " <p>ClassName:MemberQueryModel.java </p>")
     ...
     * @author wuqiong  2016年7月14日
     */
    @ApiModel(description = " <p>ClassName: MemberQueryByStoreModel.java </p>")
     ...
     * @author wuqiong  2016年7月14日
     */
    @ApiModel(description = " <p>ClassName: TradeQueryModel.java </p>")
     ...
     * @author wuqiong  2016年7月14日
     */
    @ApiModel(description = " <p>ClassName:TradeQueryByStoreModel.java </p>")
     ...
     * @author wuqiong  2016年7月14日
     */
    @ApiModel(description = " <p>ClassName:CampaignQueryModel.java </p>")
     ...
     * @author wuqiong  2016年7月14日
     */
    @ApiModel(description = " <p>ClassName:CampaignQueryByStoreModel.java </p>")
     ...
     */
    @ApiModel(description = " <p>ConponsQueryModel.java </p>")
     ...
     * @author zhangfei  2016年11月14日
     */
    @ApiModel(description = " <p>ConponsQueryByStoreModel.java </p>")
     ...
     * @author zhangfei  2016年11月14日
     */
    @ApiModel(description = " <p>PlanQueryModel.java </p>")
     ...
     * @author zhangfei  2016年11月14日
     */
    @ApiModel(description = " <p>PlanQueryByStoreModel.java </p>")
