 ...
 */@ApiModel(description = " 店铺商品产品系统业务流水信息接口模型")
...
RESUME_ITEM-暂停售卖商品，
PAUSE_ITEM-恢复售卖商品
	 */@ApiModelProperty(notes = " 操作动作。CREATE_SHOP-创建门店，MODIFY_SHOP-修改门店，CREATE_ITEM-创建商品，MODIFY_ITEM-修改商品，EFFECTIVE_ITEM-上架商品，INVALID_ITEM-下架商品，RESUME_ITEM-暂停售卖商品，PAUSE_ITEM-恢复售卖商品")
	@ApiField("action")
	private String action;

	/**
	 * 操作模式：NORMAL-普通开店
	 */@ApiModelProperty(notes = " 操作模式：NORMAL-普通开店")
	@ApiField("action_mode")
	private String actionMode;

	/**
	 * 支付宝流水ID
	 */@ApiModelProperty(notes = " 支付宝流水ID")
	@ApiField("apply_id")
...
特别注意对于门店创建，当流水status=SUCCESS时，此字段才为shop_id，其他状态时为0或空。
	 */@ApiModelProperty(notes = " 业务主体ID。根据biz_type不同可能对应shop_id或item_id。特别注意对于门店创建，当流水status=SUCCESS时，此字段才为shop_id，其他状态时为0或空。")
	@ApiField("biz_id")
	private String bizId;

	/**
	 * 业务类型：SHOP-店铺，ITEM-商品
	 */@ApiModelProperty(notes = " 业务类型：SHOP-店铺，ITEM-商品")
	@ApiField("biz_type")
	...
	/**
	 * 操作用户的支付账号id
	 */@ApiModelProperty(notes = " 操作用户的支付账号id")
	@ApiField("op_id")
	private String opId;

	/**
	 * 注意：此字段并非外部商户请求时传入的request_id，暂时代表支付宝内部字段，请勿用。
	 */@ApiModelProperty(notes = " 注意：此字段并非外部商户请求时传入的request_id，暂时代表支付宝内部字段，请勿用。")
	@ApiField("request_id")
...
<a href="https://doc.open.alipay.com/doc2/detail.htm?spm=a219a.7629140.0.0.lL9hGI&treeId=78&articleId=103834&docType=1#s2">点此查看</a>
	 */@ApiModelProperty(notes = " 流水处理结果码")
	@ApiField("result_code")
	private String resultCode;

	/**
	 * 流水处理结果描述
	 */@ApiModelProperty(notes = " 流水处理结果描述")
	 ...
	 */@ApiModelProperty(notes = " 流水子状态：WAIT_CERTIFY-等待认证，LICENSE_AUDITING-证照审核中，RISK_AUDITING-风控审核中，WAIT_SIGN-等待签约，FINISH-终结。")
	@ApiField("sub_status")
